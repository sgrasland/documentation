...
**Attention** : L'utilisation de la commande `git reset` doit se limiter au repository local car avec certaines options elle peut modifier **l'historique des commits**.
