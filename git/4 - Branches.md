...
- On **delete** enfin la branche créée spécifiquement pour la feature avec `git branch -D [BRANCH NAME]` (ou `-d` si la branche a été poussée sur le repository distant)
